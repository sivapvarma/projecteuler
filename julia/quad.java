...
public void run() {
  ...
  w("<P>If you found any mistake or any solution is missing, please send me an <A HREF=\"mailto:alpertron@hotmail.com?subject=Error solving: "+txt.replace(' ',' ')+"\">e-mail</A><P>");
